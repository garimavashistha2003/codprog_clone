...
export async function myCourseLoader({ request }) {
  ...
  const subscriptionsEndpoint = `https://uiofydrduzltnagajzvr.supabase.co/rest/v1/subscriptions?user_id=eq.${user_id}&select=*`
  ...
  const coursesNumbers = subscriptions
    ...
    .join(",");
  const myCoursesEndpoint = `https://uiofydrduzltnagajzvr.supabase.co/rest/v1/courses?id=in.%28${coursesNumbers}%29`;
